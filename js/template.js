        ...
        <div class="basket-upper">
            <div class="basket-left">
                ...
                <span class="basket-description">
                    <span class="basket-dish font"><b>${
                      addedNames[i]
                    }</b></span>
                    <span class="basket-dish-description font">${
                      addedDescriptions[i]
                    }</span>
                </span>
            </div>
            <div class="basket-right">
                <div class="basket-pricing font" id="subtotal-amount">${calcPrice(
                  addedAmount[i],
                  addedPricings[i]
   ...
   <div class="basket-calc">
      <div class="basket-calc-left font">
        ...
        <div class="basket-calc-right font">
           ...
           <h4><span>${total(subTotal(), extraCost).replace(
             ".",
             ","
           )}</span>€</h4>
        </div>
    </div>
    <div id="payButton" class="paybutton"><h4>Bezahlen <span>(${total(
      subTotal(),
      extraCost
    ).replace(".", ",")}€)</span></h4></div>
    `;
